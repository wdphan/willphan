    ...
    <div className="index-wrapper">
      ...
      <div style={{ display : `flex` }}>
        <div className="css-typing">
          <p className="index-1">developer/builder... web3 / blockchain / 3d </p>
          <p className="index-2">previously @<a style={{ color: `#44e407` }} href="https://www.jpmorgan.com/global" target="_blank" rel="noopener noreferrer">JPMorgan</a> 4 years, currently @
